...
![Landing page der Zeit.shift-Sammlung auf Historypin.](home.webp)
...
![Galerieansicht der Zeit.shift-Sammlung, die eine Informationskarte, Untersammlungen und einzelne Anzeigen auflistet](gallery.webp)
...
![Durch Anklicken kannst du mithilfe der „zu lokalisieren" und „zu taggen" Tags nach den Anzeigen filtern, die noch bearbeitet werden müssen. Die Tags lassen sich durch einen Klick automatisch in die Suchzeile einfügen.](search2.webp)

![Durch einen Klick wird das „zu lokalisieren“ Tag links oben automatisch in die Suchzeile rechts oben im Bildschirm eingefügt](search3.webp)
...
![Um die Suche nach einem Tag zu deaktivieren, klicke auf das zugehörige 🗙-Icon in der Suchzeile.
](search4.png)

![Um nach Anzeigen zu suchen, die Kommentare enthalten, tippe „hat“ in die Suchbox und klicke auf die angebotene Option.](search.png)
...
![Mithilfe des Drop-Down-Menüs kannst du Anzeigen alphabetisch oder chronologisch sortieren.
](sort.png)
-->
...
![Landingpage der Untersammlung **Tiroler Grenzbote** in Zeit.shift.](tigbo.webp)
...
![Schlage einen besseren Ort vor-Fenster. **Das Kommentarfeld ist obligatorisch!**](location.webp)
...
![Tag eintippen und aus der Liste von Tagvorschlägen auswählen.](tags.webp)
...
![Klicke auf den **Teilen**-Button im rechten Seitenmenü, um eine Anzeige über Social Media oder über eine Webseite zu teilen.](share.webp)
...
![Klicke auf den Herz-Button auf den ♡ -Button im rechten Seitenbalken, um eine Anzeige in deiner Favoritenliste zu speichern.](favourite.webp)

![Klicke auf den _Mein Profil_ Button in der oberen rechten Ecke des Bildschirms, um in dein Historypin-Profil einzusteigen und deine Favoriten zu sehen.](profile.webp)

![Du kannst deine Favoritenliste in deinem Historypin-Profil in dem Abschnitt Favoriten aufrufen.
](favourite2.webp)
...
![Der **Repin**-Button im rechten Seitenbalken erlaubt es Dir, die Anzeige zu einer anderen Sammlung hinzuzufügen, auf die Du Zugriff hast, inklusive Deiner eigenen.](repin.webp)
...
![Um das Chat-Fenster zu öffnen, klicke auf den pinken Button in der unteren rechten Ecke deines Bildschirms.](chat_closed.webp)

![Offenes Chat-Fenster. Um das Fenster zu schließen, klicke auf das pinke Pfeilsymbol unten rechts.](chat_open.webp)
